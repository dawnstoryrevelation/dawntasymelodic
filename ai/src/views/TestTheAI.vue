<template>
  <div class="test-container">
    <div class="test-header">
      ...
      <p class="description">Try out the AI without signing up. Conversations are not saved.</p>
    </div>
    ...
    <div class="footer">
      ...
      <p>Powered by the Dawntasy universe.</p>
    </div>
  </div>
</template>
...
const getFirebaseFunctions = () => {
  try {
    ...
    console.error("Error getting Firebase Functions:", error);
    return null;
  }
};
